...
public class ProcessosRESTService {
	...
	@GET
	@Path("empresa/{id_empresa}/data/{data_mod}")
	public ProcessosProtos.Processos listarProcessosCorrentesEmpresa(@PathParam("id_empresa") String id_empresa, @PathParam("data_mod") String data_mod) {
