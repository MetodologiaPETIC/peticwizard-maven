...
@NamedQueries({
		@NamedQuery(name = AcaoGenerica.LISTAR_TODOS, query = "SELECT a FROM AcaoGenerica a ORDER BY a.idFormatado"),
...
public class AcaoGenerica implements Serializable, Comparable<AcaoGenerica> {
	...
	public static final String LISTAR_TODOS = "AcaoGenerica.listarTodos";
