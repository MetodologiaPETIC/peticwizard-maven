...
public class SubareaDAO implements Serializable {
	...
	/**
	 * Busca no banco de dados registros correspondentes à entidade {@link Subarea}
	 ...
	 *         correspondentes à entidade <code>Subarea</code> encontrados. Essa
	...
	public List<Subarea> listarTodos() {
		return entityManager.createNamedQuery(Subarea.LISTAR_TODOS, Subarea.class)
				.getResultList();
	}
